                            ...
                            <div className="bg-white rounded shadow py-7">
                                <div className="hidden lg:block md:hidden">
                                    <div className="px-7 header flex bg-white lg:justify-around md:justify-around justify-start py-[30px] border-b-[2px] border-slate-100 flex-wrap gap-x-4 ">
                                        <a className="cursor-pointer" onClick={() => handleTabClick("Home")}>
                                        ...
                                        <a className="cursor-pointer" onClick={() => handleTabClick("About")}>
                                        ...
                                        <a className="cursor-pointer" onClick={() => handleTabClick("Contact")}>
                                            <div className="flex items-center group">
                                                <div className="svg-container">
                                                    <svg
                                                        className="text-[#1E293B] group-hover:text-indigo-700"
                                        ...
                                        <a className="cursor-pointer" onClick={() => handleTabClick("Pricing")}>
                                            <div className="flex items-center group ">
                                                <div className="svg-container">
                                                    <svg
                                                        className="text-[#1E293B] group-hover:text-indigo-700"
                                        ...
                                        <a className="cursor-pointer" onClick={() => handleTabClick("Auth")}>
                                            <div className="flex items-center group">
                                                <div className="svg-container">
                                                    <svg
                                                        className="text-[#1E293B] group-hover:text-indigo-700"
...
text-base font-medium leading-none text-gray-600 group-hover:text-indigo-700 mt-[1px] cursor-pointer group-hover:bg-indigo-100 group-hover:font-medium group-hover:text-indigo-700 group-hover:rounded w-full p-3"
                                ...
                                <div className="flex flex-col flex-wrap items-center justify-center w-full px-7 lg:flex-row lg:justify-end md:justify-end gap-x-4 gap-y-4">
                                    ...
                                    <button className="bg-[#452a72] rounded  border border-[#452a72] transform duration-300 ease-in-out text-sm font-medium px-6 py-4 text-white  lg:max-w-[144px] w-full ">
                                        Update
                                    </button>
                                </div>
                            </div>
