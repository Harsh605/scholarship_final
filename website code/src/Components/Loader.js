...
function Loader() {
  return (
    <>
      <div className="bg-gray-100 h-[100vh] w-full flex justify-center items-center">
        <div className="px-4 py-12 bg-white w-full h-full flex flex-col justify-center items-center">
